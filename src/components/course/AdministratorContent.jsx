...
export function AdministratorContent () {
  const {
    courses,
    loading,
    error,
  ...
  return (
    <section className='py-8 px-12 flex-1 flex flex-col justify-between'>
  ...
  return (
    ...
    >
      ...
      <Button
        ...
        className='w-fit h-fit border border-stone-300 rounded-xl self-end mx-4 mb-4 bg-sky-600 text-sky-100 flex gap-1'
      >
        Ver grupos
