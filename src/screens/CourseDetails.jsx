...
function GroupCard ({ name, schedules, teacher, id }) {
  ...
  return (
    <article className='shadow-sm  rounded-xl flex flex-col border bg-stone-100 border-stone-300 justify-between gap-2'>
      <header
        className='flex flex-1 max-h-fit bg-indigo-500 w-full h-full rounded-t-xl text-indigo-100 justify-between px-4 py-4 items-center'
      >
      ...
      <Button
        ...
        className='self-end justify-self-end bg-indigo-500 text-white border-0 hover:bg-indigo-600 m-4 flex gap-1'
      >
        Ver grupo
